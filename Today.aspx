            ...
            <%-- WIZARD STEPS --%>
             <WizardSteps>
                        ...
                        <asp:WizardStep ID="Wiz1" runat="server" title="Step 1">
                            <asp:Label ID="Label1" runat="server" Text="Today is: " Font-Size="X-Large"></asp:Label>
                             <asp:Label ID="Label8" runat="server" Font-Size="X-Large">  <%=DateTime.Now.ToString("dd/MM/yyyy") %></asp:Label>
                            ...
                            <asp:DropDownList ID="DdlTime" runat="server">
                                ...
                                <asp:ListItem Value="12:00 PM">12:00 AM</asp:ListItem>
                        ...
                        <asp:WizardStep ID="Wiz3" runat="server" title="Step 3">
                            ...
                            <br />
                            <br />
                            <asp:Label ID="Label7" runat="server" Text="Were there any animals nearby?" Font-Size="X-Large"></asp:Label>

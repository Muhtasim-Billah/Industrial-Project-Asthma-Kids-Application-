...
namespace AsthmaApp
{
    public partial class NotToday : System.Web.UI.Page
    {
        ...
        protected void FinishButton_Click(object sender, EventArgs e)
        {
            ...
            insert.Parameters.AddWithValue("@i_year", Calendar1.SelectedDate.Year);
            string monName = getMonthName(Calendar1.SelectedDate.Month);
            insert.Parameters.AddWithValue("@i_month", monName);
            insert.Parameters.AddWithValue("@i_Day", Calendar1.SelectedDate.Day);
